...
const style = [
  ...
  "a{color:inherit}.site-header{position:sticky;top:0;z-index:20;background:rgba(255,255,255,.94);backdrop-filter:blur(12px);border-bottom:1px solid var(--line)}",
  ".nav-shell{width:min(1200px,100%);margin:0 auto;padding:0 24px;min-height:64px;display:flex;align-items:center;justify-content:space-between;gap:16px}",
  ".brand{display:inline-flex;align-items:center;gap:9px;color:var(--ink);font-family:'Bricolage Grotesque',system-ui,sans-serif;font-size:19px;font-weight:700;text-decoration:none;letter-spacing:-.04em;white-space:nowrap}",
  ".brand-mark{display:block;width:34px;height:34px;border-radius:10px;overflow:hidden;flex:0 0 auto}.brand-mark img{display:block;width:100%;height:100%;object-fit:cover}",
  ".nav-links{display:flex;align-items:center;justify-content:flex-end;gap:4px;flex-wrap:wrap}.nav-links a{color:#52627a;border-radius:999px;padding:9px 12px;font-size:14px;font-weight:600;text-decoration:none}.nav-links a:hover{background:#e9f8f5;color:var(--teal-dark)}",
  ".nav-cta{margin-left:8px;border:0;border-radius:999px;padding:10px 16px!important;background:#0d9488;color:#fff!important}.nav-cta:hover{background:#0f766e!important;color:#fff!important}",
  ...
  "@media (max-width:900px){.nav-shell{padding:0 18px}.nav-links a:nth-child(n+3):not(.nav-cta){display:none}.nav-cta{margin-left:2px}}@media (max-width:700px){.article-shell{padding:36px 18px 70px}.article-header{margin-top:32px}h1{font-size:45px}.deck{font-size:18px}.article-body{margin-top:42px;font-size:17px}.related-grid{grid-template-columns:1fr}.footer-shell{padding:24px 18px}}"
].join("");
...
const buildPage = (post) => {
  ...
  return [
    ...
    '<a class="brand" href="/" aria-label="PlacementDo home"><span class="brand-mark"><img src="/apple-touch-icon.png" alt="PlacementDo logo" loading="eager"></span><span>Placement<span style="color:#0d9488">Do</span></span></a>',
    '<div class="nav-links"><a class="nav-link" href="/blog">Blog</a><a class="nav-link" href="/placement-preparation-complete-guide">Placement Guide</a><a class="nav-link" href="/aptitude-questions">Aptitude</a><a class="nav-link" href="/coding-interview-questions">Coding</a><a class="nav-link" href="/seo-resources">Resources</a><a class="nav-link" href="/demo">Demo</a><a class="nav-cta" href="/dashboard">Get started <span aria-hidden="true">↗</span></a></div>',
    "</nav></header>",
